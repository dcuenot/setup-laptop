...
if [ "$(ssh-add -l)" == "The agent has no identities." ]; then
  ssh-add ~/.ssh/id_rsa
  ssh-add ~/.ssh/id_bercail_rsa
  ssh-add ~/.ssh/id_github
fi

# Aliases for ES
alias es_dev='ssh -f -N -L 2080:ife-es-dev-master:9100 -L 2081:ife-es-dev-master:9200 ife-es-dev-master'
alias es_qa='ssh -f -N -L 2080:ife-es-qa-master:9100 -L 2081:ife-es-qa-master:9200 ife-es-qa-master'
